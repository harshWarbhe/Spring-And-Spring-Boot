...
public class DateTimeTestRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		/*
		 * try { Politician politician=new Politician("amit sha1",true,"gujarat");
		 * politician.setDob(LocalDate.of(1975, 12, 13));
		 * politician.setTob(LocalTime.of(15, 20, 10));
		 * politician.setDoj(LocalDateTime.of(1990,10,21,10,10,34)); String
		 * msg=service.registerPolitician(politician); System.out.println(msg); }
		 * catch(Exception e) { e.printStackTrace(); }
		 */

//		try {
//			Politician politician = service.showPoliticianById(1021);
...
//		try {
//			String msg = service.getPoliticianAgeById(1021);
