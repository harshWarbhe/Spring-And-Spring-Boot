...
public class ActorMgmtServiceImpl implements IActorMgmtService {
	...
	/*
	 * create or replace PROCEDURE P_GET_ACTORS_BY_CATEGORIES ( CAT1 IN VARCHAR2 ,
	 * CAT2 IN VARCHAR2 , CAT3 IN VARCHAR2 , DETAILS OUT SYS_REFCURSOR ) AS BEGIN
	 * OPEN DETAILS FOR SELECT * FROM jpa_actor_tab1 where actor_category
	 * in(cat1,cat2,cat3) order by actor_category;
	 * 
