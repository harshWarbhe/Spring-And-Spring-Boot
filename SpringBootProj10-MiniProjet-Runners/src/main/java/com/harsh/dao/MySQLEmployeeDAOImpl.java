...
public class MySQLEmployeeDAOImpl implements IEmployeeDAO {
	private   static  final String GET_EMPS_BY_DESGS="SELECT EID,ENAME,DESG,SALARY FROM EMPLOYEE WHERE DESG IN(?,?,?) ORDER BY DESG";
	...
	public MySQLEmployeeDAOImpl() {
		System.out.println("MySQLEmployeeDAOImpl:: 0-param construcctor");
	}
