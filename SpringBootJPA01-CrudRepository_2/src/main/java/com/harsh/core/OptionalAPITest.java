...
public class OptionalAPITest {
	...
	public Optional<Date> showDateByMonth1(int month) {
		if (month >= 1 && month <= 12)
			return Optional.of(new Date(month)); //2025, month, 1
		else
	...
	public static void main(String[] args) {
		/*
		 * OptionalAPITest test1=new OptionalAPITest(); Date
		 * d=test1.showDateByMonth(-10); System.out.println("mont is "+d.getMonth());
		 */
